...
### Model application
The Yield YH determines the oxygen consumption required for biomass growth. The growth rate µmax determines the speed of growth. However, this is only the case with an unlimited supply of substrate.
The decay rate bH and the sludge retention time SRT determine the biomass content in the reactor. This has a direct influence on the absolute growth of the biomass.
  
  
### Tasks

* Evaluate the quality of the model fit! Describe things that could be improved!
* Describe the change in oxygen uptake rate (respiration rate) OUR when YH is minimized or maximized!
* When you increase the SRT what effect can be seen regarding the biomass content XH?
* If the decay rate bH is increased what effect has this to the substrate concentration in the effluent?
...
model_ode <- function(t, state, params, influentfcn, wasfcn) {
  with(as.list(c(state, params)), {
    ...
    # SO oxygen - no transport only change due toprocesses for OUR calculation
    dSO_AS <- r_SO
    dSO_SC <- 0
