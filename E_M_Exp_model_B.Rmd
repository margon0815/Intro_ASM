...
### Model description
In model version A it was obvious that there is no good fit. The rise and decline of OUR was to sharp. We need some processes to slow down the dynamics. This can be done with a hydrolysis process. A part of substrate (new fraction XS; see figure 1) from influent is not readily biodegradable but needs to be converted first. This hydrolysis process is modelled surface-dependent from the available biomass. Additional parameters kh as speed of hydrolysis and Kx as half saturation value are necessary.  
...
### Model application
Depending on the speed of the hydrolysis process the smoothing of OUR can be influenced.
