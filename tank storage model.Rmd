...
```{r wd_check, echo=FALSE}
cat("getwd():", getwd(), "\n")
cat("Files:", paste(list.files(), collapse = ", "))
```


![Figure 1: System definiton](www/storage_model_image.png)
...
output$tankPlot <- renderPlot({
  ...
  mtext("Effluent Q_out [m³ h-1]", side = 4, line = 3, col = "black")
