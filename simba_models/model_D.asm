...
<ASM id="model_D" asmType="ASM" Descr="simple growth model" author="Ahnert M. based on Ekama model (from Gujer and Henze)" publisherEMail="markus.ahnert@tu-dresden.de" valid="True" fastType="Cs">
   <dyas />
   <UProps>
   ...
   <Qlist id="model_D" Descr="simple growth model" w="1" col="#FF0000FF" isFlow="Flow" flowUnit="m^3/d" Rho="1000">
      ...
      <Quality id="SNH" Descr="" UnitID="" SX="1" SXe="Soluble" aTS="0" Diff="0" Gas="-" loadUnitID="" loadScal="0.001" loadCol="#FF0000FF">
         <parameters>
            <par id="TSS" val="0" />
            <par id="VSS" val="0" />
            <par id="ISS" val="0" />
      ...
      <Quality id="SNO" Descr="" UnitID="" SX="1" SXe="Soluble" aTS="0" Diff="0" Gas="-" loadUnitID="" loadScal="0.001" loadCol="#FF0000FF">
         <parameters>
            <par id="TSS" val="0" />
            <par id="VSS" val="0" />
            <par id="ISS" val="0" />
      ...
      <Quality id="XS" Descr="slowly biodegradable substrate" UnitID="" SX="2" SXe="Particulate" aTS="0" Diff="0" Gas="-" loadUnitID="" loadScal="0.001" loadCol="#FF0000FF">
         <parameters>
            <par id="TSS" val="0" />
            <par id="VSS" val="0" />
            <par id="ISS" val="0" />
            <par id="N" val="i_NBM" />
            <par id="TKN" val="i_NBM" />
            <par id="N_fil" val="0" />
            <par id="N_sol" val="0" />
            <par id="NOx" val="0" />
            <par id="ThOD" val="1" />
            <par id="ThN" val="i_NBM" />
            <par id="P" val="0" />
            <par id="Charge" val="0" />
            <par id="Metal" val="0" />
            <par id="C" val="0" />
      ...
      <Quality id="XI" Descr="" UnitID="" SX="2" SXe="Particulate" aTS="0" Diff="0" Gas="-" loadUnitID="" loadScal="0.001" loadCol="#FF0000FF">
         <parameters>
            <par id="TSS" val="0" />
            <par id="VSS" val="0" />
            <par id="ISS" val="0" />
      ...
      <Quality id="XBA" Descr="" UnitID="" value="1" SX="2" SXe="Particulate" aTS="0.66" Diff="0" Gas="-" loadUnitID="" loadScal="0.001" loadCol="#FF0000FF">
         <parameters>
            <par id="TSS" val="0.66" />
            <par id="VSS" val="0.66" />
            <par id="ISS" val="0" />
   ...
   <pars>
      <expr id="mu_maxH" formula="4" Descr="-" UnitID="d^-1" groupId="" />
      ...
      <expr id="kh" formula="2" Descr="-" UnitID="-" groupId="" />
      <expr id="Kx" formula="0.04" Descr="-" UnitID="-" groupId="" />
      <expr id="f_p" formula="0.08" Descr="-" UnitID="-" groupId="" />
      <expr id="mu_maxA" formula="1" Descr="-" UnitID="-" groupId="" />
      <expr id="K_NH_H" formula="0.1" Descr="-" UnitID="-" groupId="" />
      <expr id="K_NH_A" formula="1" Descr="-" UnitID="-" groupId="" />
      <expr id="YA" formula="0.24" Descr="-" UnitID="-" groupId="" />
      <expr id="bA" formula="0.1" Descr="-" UnitID="-" groupId="" />
      <expr id="i_NBM" formula="0.08" Descr="-" UnitID="-" groupId="" />
   </pars>
   <exvars />
   <ivars />
   <algvars />
   <procs>
      <proc id="het_growth" rate="mu_maxH*SS/(SS+K_S)*SNH/(SNH+K_NH_H)*XH" Descr="heterotrophic growth" UnitID="">
         <stoichio>
            ...
            <expr id="SNH" formula="-i_NBM" Descr="-" UnitID="-" groupId="" />
         </stoichio>
      </proc>
      <proc id="hydrolysis" rate="kh*(XS/XH)/(Kx+XS/XH)*XH" Descr="" UnitID="">
         <stoichio>
            <expr id="SS" formula="1" Descr="-" UnitID="-" groupId="" />
            <expr id="XS" formula="-1" Descr="-" UnitID="-" groupId="" />
            <expr id="SNH" formula="i_NBM" Descr="-" UnitID="-" groupId="" />
         </stoichio>
      </proc>
      <proc id="het_decay" rate="bH*XH" Descr="" UnitID="">
         <stoichio>
            <expr id="XH" formula="-1" Descr="-" UnitID="-" groupId="" />
            <expr id="XS" formula="1-f_p" Descr="-" UnitID="-" groupId="" />
            <expr id="XI" formula="f_p" Descr="-" UnitID="-" groupId="" />
         </stoichio>
      </proc>
      <proc id="aut_growth" rate="mu_maxA*SNH/(SNH+K_NH_A)*XBA" Descr="autotrophic growth" UnitID="">
         <stoichio>
            <expr id="SNH" formula="-1/YA-i_NBM" Descr="-" UnitID="-" groupId="" />
            <expr id="XBA" formula="1" Descr="-" UnitID="-" groupId="" />
            <expr id="SNO" formula="1/YA" Descr="-" UnitID="-" groupId="" />
            <expr id="SO" formula="(YA-4.57)/YA" Descr="-" UnitID="-" groupId="" />
         </stoichio>
      </proc>
      <proc id="aut_decay" rate="bA*XBA" Descr="" UnitID="">
         <stoichio>
            <expr id="XBA" formula="-1" Descr="-" UnitID="-" groupId="" />
            <expr id="XI" formula="f_p" Descr="-" UnitID="-" groupId="" />
            <expr id="XS" formula="1-f_p" Descr="-" UnitID="-" groupId="" />
