...
<ASM id="model_C" asmType="ASM" Descr="simple growth model" author="Ahnert M. based on Ekama model (from Gujer and Henze)" publisherEMail="markus.ahnert@tu-dresden.de" valid="True" fastType="Cs">
   <dyas />
   <UProps>
   ...
   <Qlist id="model_C" Descr="simple growth model" w="1" col="#FF0000FF" isFlow="Flow" flowUnit="m^3/d" Rho="1000">
